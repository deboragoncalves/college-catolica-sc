      ...
      <form action="<?php echo $action; ?>" method="post">
        ...
        <div class="form-group">
          ...
          <div class="container-input container-input-checkbox">
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="checkbox" value="praia" name="interesses[]">
              <label class="form-check-label" for="checkboxPraia">Praia</label>
            </div>
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="checkbox" value="campo" name="interesses[]">
              <label class="form-check-label" for="checkboxCampo">Campo</label>
            </div>
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="checkbox" value="nacionais" name="interesses[]">
              <label class="form-check-label" for="checkboxNacionais">Nacionais</label>
            </div>
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="checkbox" value="internacionais" name="interesses[]">
              <label class="form-check-label" for="checkboxInternacionais">Internacionais</label>
            </div>
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="checkbox" value="serra" name="interesses[]">
              <label class="form-check-label" for="checkboxSerra">Serra</label>
            </div>
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="checkbox" value="cidade" name="interesses[]">
