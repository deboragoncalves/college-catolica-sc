...
const montarLayout = pacote => {
    ...
    let primeiroSubcontainerImagens = document.createElement("div");
    let imagem1 = document.createElement("img");
    imagem1.src = pacote.imagens[0];

    let imagem2 = document.createElement("img");
    imagem2.src = pacote.imagens[1];
    
    primeiroSubcontainerImagens.appendChild(imagem1);
    primeiroSubcontainerImagens.appendChild(imagem2);

    let segundoSubcontainerImagens = document.createElement("div");
    let imagem3 = document.createElement("img");
    imagem3.src = pacote.imagens[2];

    let imagem4 = document.createElement("img");
    imagem4.src = pacote.imagens[3];

    segundoSubcontainerImagens.appendChild(imagem3);
    segundoSubcontainerImagens.appendChild(imagem4);

    containerImagens.appendChild(primeiroSubcontainerImagens);
    containerImagens.appendChild(segundoSubcontainerImagens);
    ...
    let containerBotaoComprar = document.createElement("div");
    containerBotaoComprar.classList.add("container-botao-comprar");
    ...
    containerBotaoComprar.appendChild(botaoComprar);
    ...
    subcontainerDetalhes.appendChild(containerImagens);
    subcontainerDetalhes.appendChild(containerBotaoComprar);
